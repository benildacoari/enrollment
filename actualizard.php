  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <?php 
        ...
        $idpers=$_GET['idni'];
        echo '<form action="recibir_acd.php" method="POST" class="form-horizontal" role="form">
          <fieldset class="col-lg-10"><legend class="text-primary leg"><strong>Datos Personales</strong></legend>';
 
          
            $resultado1=mysqli_query($link,'SELECT * FROM dat_personales as dp INNER JOIN dat_domicilio as dd INNER JOIN dat_labs as dl INNER JOIN niv_educativo as ne
              where dd.iddat_dom=dp.iddat_pers and dl.iddat_labs=dp.iddat_pers and ne.idniv_educ=dp.iddat_pers and dp.iddat_pers= '.$idpers.'');
            ...
            while($dato = mysqli_fetch_array($resultado1)){
              ...
              <div class="form-group">
                ...
                <div class="col-lg-5 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="nombres" class="form-control" value="'.$dato['nombres'].'" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ ]{2,34})" maxlength="34" required autofocus>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="nro_cel" class="form-control" value="'.$dato['nro_cel'].'" pattern="[0-9]{9}" title="Ingrese números." maxlength="12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="nro_tel" class="form-control" value="'.$dato['nro_tel'].'"  pattern="[0-9]{6,10}" title="Ingrese números." maxlength="12">
                </div>
              </div></fieldset>
            ...
            <fieldset class="col-lg-10"><legend class="text-primary leg"><strong>Datos de domicilio</strong></legend>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-7 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="departamento" class="form-control"pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ ]{2,25})" value="'.$dato['departamento'].'" maxlength="45">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-7 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="provincia" class="form-control" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ ]{2,25})" value="'.$dato['provincia'].'" maxlength="45">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6 col-md-4 col-sm-4 col-xs-8">
                  <input type="text" name="distrito" class="form-control" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ ]{2,25})" value="'.$dato['distrito'].'" maxlength="45">
                </div>
                <label class="col-lg-1 col-md-1 col-sm-1 col-xs-1 control-label text-info">(*)</label>
              </div></fieldset>
