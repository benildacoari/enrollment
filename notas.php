  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="panel panel-primary">
        <div class="panel-heading">REPORTE DE NOTAS POR ESPECIALIDAD: </div>
            ...
            if(isset($_REQUEST['ver_t'])){
              ...
              echo "<table class='table table-hover'><thead><tr><th>Especialidad</th><th>Fecha de inicio</th><th></th></tr></thead><tr>";
                while($dato = mysqli_fetch_array($resultado)){
                  ...
                  <td><a href='form_notas.php?idc=" . $dato['id_especialidad'] ."' class='btn btn-default btn-sm' ";if($cant==0){echo "disabled";} echo "><span class='glyphicon glyphicon-ok-circle'></span> Ingresar Notas</a></td></tr>";
                }  
              echo "</table>";
            }else{
