  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-md-4">
      ...
      <?php
        ...
        $consulta="SELECT CONCAT(nombres,' ',ap_paterno,' ',ap_materno) as nom FROM dat_personales where iddat_pers=".$iddat."";
        $resultado= mysqli_query($link,$consulta);
        $array=mysqli_fetch_row($resultado);
        $nombres=$array[0];  
        echo "<div class='panel-heading'><b>HISTORIAL DE NOTAS - ".$nombres."</b></div>";

        $consul='SELECT nombre_espec,nota,fecha_inicio FROM especialidad as es inner join matricula as ma inner join notas as no
        where es.id_especialidad=ma.id_especialidad and ma.idmatricula=no.idmatricula and ma.iddat_pers='.$iddat.'';
        $resultado1=mysqli_query($link,$consul);
        echo "<div class='panel-body'>" ;
      		echo "<table class='table' >
            <tr><th>Especialidad</th><th>Nota</th><th>Fecha</th></tr>";
